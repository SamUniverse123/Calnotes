  ...
  return (
    <div>
      <a href="#" className="group relative block ">
        ...
        >
          <div className="w-full h-[47.7%] overflow-hidden rounded-t-[3px] lg:rounded-t-3xl bg-white"></div>
          <div className=" flex items-center w-full h-[15.8%] pl-2 lg:pl-6 border-y-[2px] border-x-0 border-black border-double bg-white text-lg lg:text-4xl font-semibold">
            {title}
          </div>
          <div
            className={`w-full h-[36.5%] rounded-b-[3px] lg:rounded-b-xl ${colourVariants[colour]}`}
          >
            <div></div>
            <div></div>
          </div>
